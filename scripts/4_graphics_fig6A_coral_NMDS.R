...
#### load data ####
coral_site_trans <- read.csv("data_output_old/benthic_transects_mean_coral.csv", header = TRUE)  
...
coral_site_trans <- select(coral_site_trans, -c(1:4))        # remove blank columns 
...
ggsave("graphs/Figure6A_nmds.png", width = 12, height = 6)
ggsave("graphs/Figure6A_nmds.pdf", width = 12, height = 6, dpi = 300)
