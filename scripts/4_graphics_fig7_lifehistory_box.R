## Visualisation of dispersion results - Life History
...
ggsave("graphs/Figure7_lifehist_box.pdf", width = 8, height = 12)
ggsave("graphs/Figure7_lifehist_box.tiff", width = 8, height = 12)
ggsave("graphs/Figure7_lifehist_box.png", width = 8, height = 12)
